    ...
    return (
        <div className="selected-weather">
            <h1 className="selected-temperature">
                {(selectedWeather &&
                    (settings.temperatureInF == false
                        ...
                        : (selectedWeather.main.temp * (9 / 5) + 32).toFixed(0))) ||
                    "0"}
                    ...
                    {`Feels like: ${
                        (selectedWeather &&
                            (settings.temperatureInF == false
                                ...
                                : (
                                      selectedWeather.main.feels_like * (9 / 5) +
                                      32
                                  ).toFixed(0))) ||
                        "0"
                    }`}
            ...
            <div className="more-info">
                ...
                <h2 className="sky">
                    {selectedWeather && selectedWeather.weather[0].main}
                </h2>
                <h3 className="humidity">
                    ...
                    {selectedWeather && selectedWeather.main.humidity + "%"}
                </h3>
            </div>
        </div>
    );
